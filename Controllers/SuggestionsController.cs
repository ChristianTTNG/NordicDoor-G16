...
namespace NordicDoors.Controllers
{
    public class SuggestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SuggestionId,SugName,SugDescription,RegisteredDate,CompletedDate,SugCategory,SugCreator,SugResponsible,TeamId,EstTime,SugStatus,IsJdi")] Suggestion suggestion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SuggestionId,SugName,SugDescription,RegisteredDate,CompletedDate,SugCategory,SugCreator,SugResponsible,TeamId,EstTime,SugStatus,IsJdi")] Suggestion suggestion)
        {
